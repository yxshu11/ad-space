...
ActiveRecord::Schema[7.0].define(version: 2023_06_27_054720) do
  ...
  create_table "billboards", force: :cascade do |t|
    ...
    t.index ["category_id"], name: "index_billboards_on_category_id"
  end
  ...
  add_foreign_key "billboards", "categories"
end
